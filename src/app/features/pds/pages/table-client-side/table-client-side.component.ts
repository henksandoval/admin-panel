...
import { AppFiltersAdvancedConfig, AppFiltersAdvancedOutput } from '@shared/molecules/app-filters/app-filter.model';
...
export class TableClientSideComponent implements OnInit {
  ...
  onAdvancedSearch(output: AppFiltersAdvancedOutput): void {
