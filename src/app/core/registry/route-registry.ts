...
export const ROUTE_REGISTRY: Record<string, RouteDefinition> = {
  ...
  'applications': { path: 'apps', requiresAuth: true },
  'ecommerce': { path: 'ecommerce' },
  'reports': { path: 'reports' },
  'pages': { path: 'pages' },
  'authentication': { path: 'auth' },
  'errors': { path: 'errors' },
  'user-interface': { path: 'ui', requiresAuth: true },
  ...
  'lock-screen': { path: 'lock-screen' },
  'two-factor-auth': { path: 'two-factor-auth' },
  'error-400': { path: '400' },
  'error-401': { path: '401' },
  'error-403': { path: '403' },
  'error-404': { path: '404' },
  ...
  'forms': { path: 'forms' },
  'cards': { path: 'cards' },
  'settings': { path: 'settings', requiresAuth: true, roles: ['admin'] },
